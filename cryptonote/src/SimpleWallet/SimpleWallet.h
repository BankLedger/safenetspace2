...
#if SQ_ADD_BM
	bool create_group(const std::vector<std::string> &args);
	bool join_group(const std::vector<std::string> &args);
	bool delete_group(const std::vector<std::string> &args);
	bool list_group(const std::vector<std::string> &args);
	bool name_group(const std::vector<std::string> &args);

	bool send_message(const std::vector<std::string> &args);
	bool list_message(const std::vector<std::string> &args);
	bool reply_message(const std::vector<std::string> &args);

	bool save_bm(const std::vector<std::string> &args);
#endif

#if SQ_ADD_BM_SEGMENT
	bool sendSegment(const std::vector<std::string> &args);
#endif
