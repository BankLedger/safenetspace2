...
#if SQ_ADD_BM2
  utd.m_wallet_version = serializer.m_wallet_version;
  if (utd.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(utd.m_id, "m_id");
  }
  else
  {
	  utd.m_id = ACCOUNT_OWN_ID;
  }
#endif
}
...
#if SQ_ADD_BM2
  details.m_wallet_version = serializer.m_wallet_version;
  if (details.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(details.m_id, "m_id");
  }
  else
  {
	  details.m_id = ACCOUNT_OWN_ID;
  }
#endif
}
...
#if SQ_ADD_BM2
  txi.m_wallet_version = serializer.m_wallet_version;
  if (txi.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(txi.m_id, "m_id");
  }
  else
  {
	  txi.m_id = ACCOUNT_OWN_ID;
  }
#endif
...
#if SQ_ADD_BM2
  tr.m_wallet_version = serializer.m_wallet_version;
  if (tr.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(tr.m_id, "m_id");
  }
  else
  {
	  tr.m_id = ACCOUNT_OWN_ID;
  }
#endif
}
...
#if SQ_ADD_BM2
  deposit.m_wallet_version = serializer.m_wallet_version;
  if (deposit.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(deposit.m_id, "m_id");
  }
  else
  {
	  deposit.m_id = ACCOUNT_OWN_ID;
  }
#endif
...
#if SQ_ADD_BM2
  depositInfo.m_wallet_version = serializer.m_wallet_version;
  if (depositInfo.m_wallet_version == WALLET_VERSION_BM)
  {
	  serializer(depositInfo.m_id, "m_id");
  }
  else
  {
	  depositInfo.m_id = ACCOUNT_OWN_ID;
  }
#endif
}
