...
namespace Tools
{
  ...
  private:
	...
	//json_rpc dnc1
	bool on_dnc1_getbalance(const wallet_rpc::COMMAND_RPC_GET_BALANCE_DNC1::request& req, wallet_rpc::COMMAND_RPC_GET_BALANCE_DNC1::response& res);
	bool on_dnc1_transfer(const wallet_rpc::COMMAND_RPC_TRANSFER_DNC1::request& req, wallet_rpc::COMMAND_RPC_TRANSFER_DNC1::response& res);
	bool on_dnc1_store(const wallet_rpc::COMMAND_RPC_STORE::request& req, wallet_rpc::COMMAND_RPC_STORE::response& res);
	bool on_dnc1_get_payments(const wallet_rpc::COMMAND_RPC_GET_PAYMENTS::request& req, wallet_rpc::COMMAND_RPC_GET_PAYMENTS::response& res);
	bool on_dnc1_getaddress(const wallet_rpc::COMMAND_RPC_GET_ADDRESS_DNC1::request& req, wallet_rpc::COMMAND_RPC_GET_ADDRESS_DNC1::response& res);
	bool on_dnc1_get_incoming_tx(const wallet_rpc::COMMAND_RPC_GET_INCOMING_TX_DNC1::request& req, wallet_rpc::COMMAND_RPC_GET_INCOMING_TX_DNC1::response& res);
